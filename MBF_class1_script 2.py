...
# Define bin edges with intervals of 100, from 0 to 3000
#bins = np.arange(0, 3000 + 100, 100)

# Plotting the histogram
#plt.figure(figsize=(10, 6))

# Create histogram with custom bins and x-axis limit
#plt.hist(data_MBF['RentalFeeMonthly'], bins=bins, color='blue', edgecolor='black')

# Adding titles and labels
#plt.title('Distribution of Monthly Rental Fees (Up to 3000)', fontsize=16)
#plt.xlabel('Rental Fee (Monthly)', fontsize=14)
#plt.ylabel('Frequency', fontsize=14)

# Set the x-axis limit to 0-3000
#plt.xlim(0, 3000)
